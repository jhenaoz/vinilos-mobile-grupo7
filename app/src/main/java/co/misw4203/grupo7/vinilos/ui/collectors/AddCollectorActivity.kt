...
class AddCollectorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        inputReleaseDate = findViewById(R.id.collector_release_telephone)
        inputReleaseDateLayout = findViewById(R.id.collector_release_email)
        ...
        buttonAddCollector.setOnClickListener {
